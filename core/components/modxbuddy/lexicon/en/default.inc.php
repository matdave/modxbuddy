...
$_lang['setting_modxbuddy.upload_resize_desc'] = 'Resize images on upload if over the max image dimensions. (requires Imagick extension)';
...
$_lang['setting_modxbuddy.image_resize_quality_desc'] = 'Quality of resized images. 0-100. (requires Resize Uploads)';
$_lang['setting_modxbuddy.image_convert'] = 'Convert Images';
$_lang['setting_modxbuddy.image_convert_desc'] = 'Convert uploaded images to WebP format if supported. (requires Resize Uploads)';